...
public class RobotContainer {
  ...
  private final String Test_Trajectory_A = "A";
  private final String Test_Trajectory_B= "B";
  ...
  public RobotContainer() {
    ...
    m_chooser.setDefaultOption("Test 1: Drive Straight", Test_Trajectory_A);
    m_chooser.addOption("Test 2: Simple Curve", Test_Trajectory_B);
...
private Command autoIntakeInstant(double speed){
  ...
  public Command getAutonomousCommand() {
    ...
    String TestAuto1 = "pathplanner/generatedJSON/test path 1.wpilib.json";
    String TestAuto2 = "pathplanner/generatedJSON/test path 2 - curve.wpilib.json";
    ...
    switch (m_autoSelected)
    {
        ...
        case Test_Trajectory_A:
          return new SequentialCommandGroup(followTrajectory(TestAuto1),stopRobot());

        case Test_Trajectory_B:
          return new SequentialCommandGroup(followTrajectory(TestAuto2),stopRobot());
